...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call0.Endpoint<"/sign-in/anonymous", "POST", undefined, Record<string, any> | undefined, any, {
      token: string;
    ...
    deleteAnonymousUser: better_call0.Endpoint<"/delete-anonymous-user", "POST", undefined, Record<string, any> | undefined, [better_call0.Middleware<(inputContext: Record<string, any>) => Promise<{
      session: {
