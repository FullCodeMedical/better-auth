...
declare const oneTimeToken: (options?: OneTimeTokenOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateOneTimeToken: better_call0.Endpoint<"/one-time-token/generate", "GET", undefined, Record<string, any> | undefined, [better_call0.Middleware<(inputContext: Record<string, any>) => Promise<{
      session: {
     ...
     */
    verifyOneTimeToken: better_call0.Endpoint<"/one-time-token/verify", "POST", {
      token: string;
