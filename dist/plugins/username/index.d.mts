...
declare const username: (options?: UsernameOptions | undefined) => {
  ...
  endpoints: {
    signInUsername: better_call0.Endpoint<"/sign-in/username", "POST", {
      username: string;
      password: string;
    ...
    isUsernameAvailable: better_call0.Endpoint<"/is-username-available", "POST", {
      username: string;
    }, Record<string, any> | undefined, any, {
      available: boolean;
    ...
    user: {
      fields: {
        username: {
          ...
          returned: true;
          transform: {
            input(value: _better_auth_core_db0.DBPrimitive): string | number | boolean | Record<string, unknown> | Date | unknown[] | null | undefined;
          };
        };
        displayUsername: {
          type: "string";
